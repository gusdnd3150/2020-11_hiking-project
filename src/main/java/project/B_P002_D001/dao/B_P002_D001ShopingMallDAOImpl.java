...
public class B_P002_D001ShopingMallDAOImpl implements B_P002_D001ShopingMallDAO{
	...
	@Override
	public List<Map> lastItems(Map<String, Object> info) throws DataAccessException {    //최신글 5
		List<Map> result = sqlSession.selectList("project.e_P002_D003.lastItems",info);
		return result;
	}
