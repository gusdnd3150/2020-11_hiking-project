...
public interface E_p003Controller {
	...
	public int removeCsboard(int csPostNum,HttpServletRequest request, HttpServletResponse response) throws Exception;
	public ModelAndView mailSending(Map<String, String> map, HttpServletRequest request, HttpServletResponse response) throws Exception;
