...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-house" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 <a class="list-group-item list-group-item-action" style="width:7rem;" id="list-calender-list" data-toggle="list" href="#calender" role="tab" aria-controls="calender">
...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-images" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 <a class="list-group-item list-group-item-action" style="width:7rem;" id="list-files-list" data-toggle="list" href="#files" role="tab" aria-controls="files">
