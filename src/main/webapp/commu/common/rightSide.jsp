...
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-house" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 <a class="list-group-item list-group-item-action" id="list-calender-list" data-toggle="list" href="#calender" role="tab" aria-controls="calender">
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-calendar-event" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 <a class="list-group-item list-group-item-action" id="list-album-list" data-toggle="list" href="#album" role="tab" aria-controls="album">
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-images" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
 ...
 <a class="list-group-item list-group-item-action" id="list-files-list" data-toggle="list" href="#files" role="tab" aria-controls="files">
 ...
 <a class="list-group-item list-group-item-action" id="list-member-list" data-toggle="list" href="#member" role="tab" aria-controls="member">
