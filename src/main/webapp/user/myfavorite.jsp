            ...
            <div class="row tab-pane fade show active" id="following" data-spy="scroll" role="tabpanel" aria-labelledby="following-tab">
                <ul id="a">
                    <c:forEach var="trail" items="${trail}">
                        <li class="pt-1 pb-1">
                            <a href="/trail/${trail.MNTN_CODE}.do?userId=${LOGIN}" class="row" style="color: black">
                    ...
                    <c:forEach var="group" items="${group}">
                        <li class="pt-1 pb-1">
                            <a href="/group/${group.GROUPNUM}" class="row" style="color: black">
                                <img class="rounded-circle" src="/resources/img/${group.STOREDFILENAME}" width="50" height="50">
                                <div class="row" style="padding-left: 30px; padding-top: 20px;">
                                    <h6>${group.NAME}</h6>
                                </div>
                            </a>
